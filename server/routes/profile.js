...
router.get(
  ...
  profileController.getCurrentAvailability,
  (req, res) => {
    return res
      .status(200)
      .json({ skills: res.locals.skills, availability: res.locals.availability });
  }
);
// updating skill
...
router.post(
  '/',
  profileController.addAvailability,
  profileController.getCurrentAvailability,
  (req, res) => {
...
router.delete(
  '/',
  profileController.deleteAvailability,
  profileController.getCurrentAvailability,
  (req, res) => {
    return res.status(200).json({ availability: res.locals.availability });
  }
